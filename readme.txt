...
Le programme a été diviser en plusieurs fichiers sous formes de librairies. On lance le jeu en executant le fichier principal : main.py
...
- l'IA est sur 3 niveaux (Facile : aleatoire, Moyen : probabilité, Intelligent : stratégie vue sur internet)
...
Pour plus de facilité, nous avons décidé de travailler à l'aide de GIT, avec un repository synchronisé sur le site github.com.
...
Il a également travailler sur l'élaboratin de l'IA "Intelligente" mais nous avons a la fin décider de trouver une stratégie sur wikipédia.
